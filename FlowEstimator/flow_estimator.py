...
class FlowEstimator:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'FlowEstimator_{}.qm'.format(locale))
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/FlowEstimator/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'Flow Estimator'),
            callback=self.run,
